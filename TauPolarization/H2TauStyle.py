...
histPref['ZTT_left*'] = {'style':sHTT_DYJets, 'layer':0.1, 'legend':'Z#rightarrow#tau#tau (left)'}
histPref['ZTT_right*'] = {'style':sHTT_ZL, 'layer':0, 'legend':'Z#rightarrow#tau#tau (right)'}
...
histPref['QCD*'] = {'style':sHTT_QCD, 'layer':1, 'legend':'QCD multijet'}
histPref['W'] = {'style':sHTT_WJets, 'layer':3, 'legend':'W+jets'}  
histPref['ZJ'] = {'style':sHTT_ZL, 'layer':3.1, 'legend':'Z#rightarrow#tau#tau/Z#rightarrow ll, j#rightarrow#tau'}
